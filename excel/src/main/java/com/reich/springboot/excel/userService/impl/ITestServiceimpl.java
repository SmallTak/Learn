package com.reich.springboot.excel.userService.impl;

import com.reich.springboot.excel.common.MyException;
import com.reich.springboot.excel.entity.User;
import com.reich.springboot.excel.entity.UserExample;
import com.reich.springboot.excel.mapper.UserMapper;
...
public class ITestServiceimpl implements ITestService {
        ...
        public boolean batchImport(String fileName, MultipartFile file) throws Exception {
            ...
            System.out.println(userMapper.selectByExample(new UserExample()).size());

            User user1 = new User();
            user1.setName("周云飞");
            user1.setAddress("河南周口");
            user1.setPhone("13461346731");
            user1.setDes("sasd");
            user1.setEnrolDate(new Date());
...
//                if (cnt == 0) {
                System.out.println(" 插入 "+userResord.toString());
                userMapper.insert(userResord);
